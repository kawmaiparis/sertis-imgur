		...
		return (
			<div className='base-container'>
				...
				<div className='signOut'>
					...
					<Link to='/' className='btn btn-outline-dark' isLoggedIn={false}>
						Sign out!
					</Link>
				...
				<div className='flex-container'>
					{this.state.image_locations.map((image, i) => (
						<Card key={i} imagesrc={image} />
					))}
				</div>
				...
				<div className='loading-box'>
					<div className='loading-content'>
						<span className='spinner-border spinner-border-lg' /> Uploading...
					</div>
				</div>
			</div>
		)
